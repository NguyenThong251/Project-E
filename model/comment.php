...
{
    $sql = "SELECT COUNT(DISTINCT id_product) AS quantity FROM comment;";
    return pdo_query_value($sql);
}

function comments_in_product($id_product)
{
    $sql = "SELECT c.id, c.id_product, c.id_user, c.content, c.date, u.full_name, u.user_img
            FROM comment c
