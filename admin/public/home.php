  ...
  <div class="db-account">
    ...
    <div class="db-account-info">
      <div class="db-account-container">
        <div class="db-account-info-name">Tien Bip</div><span>-</span>
        <div class="db-account-info-email">Email: meomeo@gmail.com</div><span>-</span>
        <div class="db-account-info-phone">Số điện thoại: 0123456789</div>
      </div>
