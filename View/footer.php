<div id="container-footer">
    <footer class="mt-12">
        <div class="policy grid grid-cols-1 items-center place-content-between gap-4 mt-22 lg:grid-cols-2 xl:grid-cols-5">
            ...
            <div class="px-16 py-12 flex flex-col lg:col-span-2 xl:col-span-1  items-center justify-center mt-4 md:mt-0" style="border: 1px solid rgba(0, 0, 0, 0.1);">
