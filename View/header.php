            ...
            <div class="md:w-3/4 px-8 container rounded-15 mt-8 flex items-center justify-between">
                ...
                <div class="hidden xl:block">
                    <ul class="flex text-lg gap-12">
                        ...
                        <li class="nav-items group">
                            <a class="nav-links relative before:content[''] before:absolute before:w-0 before:h-0.5 before:-bottom-1 group-hover:before:w-full before:transition-all before:duration-500 before:bg-primary" href="index.php?pg=about">Về tụi tôi</a>
                        </li>
                        <li class="nav-items group">
