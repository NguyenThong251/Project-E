...
<form action="index.php?pg=checkout" method="post" class="my-8">
    ...
    <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div class="px-4 pt-8">
            <p class=" font-bold text-primary text-h1">Order Summary</p>
        ...
        <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
            ...
            <div class="">
                ...
                <div class="relative">
                    <input required value="" type="text" name="name" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Your Name">
                ...
                <div class="relative">
                    <input required value="" type="text" id="card-holder" name="location" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm uppercase shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Your full name here" />
                    <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                ...
                <div class="relative">
                    <input required value="" type="text" id="email" name="email" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="your.email@gmail.com" />
                    <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                ...
                <div class="relative">
                    <input required value="" placeholder="xxxx-xxx-xxx" type="text" name="phone" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500">
                    <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
            ...
            <button type="submit" name="submit" class="mt-4 mb-8 w-full rounded-md bg-primary px-6 py-3 text-white font-bold">Place Order</button>
        </div>
    </div>
</form>