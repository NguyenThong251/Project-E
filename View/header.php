...
<body>
    ...
    <header>
            ...
            <div class="md:w-3/4 px-8 container rounded-15 mt-8 flex items-center justify-between">
                ...
                <div class="hidden xl:block">
                    <ul class="flex text-lg gap-12">
                        ...
                        <li class="nav-items group">
                            <a class="nav-links relative before:content[''] before:absolute before:w-0 before:h-0.5 before:-bottom-1 group-hover:before:w-full before:transition-all before:duration-500 before:bg-primary" href="index.php?pg=about">Về chúng tôi</a>
                        </li>
                        <li class="nav-items group">
        ...
        <div class="">
                                    ...
                                    <div class="w-1/4 fixed top-0 h-screen right-0 bg-white z-50 cart-nofi transition-all duration-500 delay-75 cart-hide">
                                        <div class="flex flex-col h-screen">
                                            ...
                                            <div class="p-8 flex-col flex gap-8 relative overflow-y-auto cart-box">
    
                                                
                                            </div>
                                            
                                            <div class="bg-box w-full h-1/4 mt-auto px-8 py-4">
                                                <div class="flex justify-between  text-xl font-bold">
                                                    <h1 class="">Subtotal</h1>
                                                    <p class="font-medium total-price">999999 VND</p>

                                                </div>
                                                <div class="flex flex-col items-center gap-2 mt-4">
                                                    <a class="w-full text-white text-center font-bold text-2xl bg-primary rounded-button px-4 py-2">Checkout</a>
                                                    <a class="w-full text-white text-center font-bold text-2xl bg-primary rounded-button px-4 py-2">Viewcart</a>
